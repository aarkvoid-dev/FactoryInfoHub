...
urlpatterns = [
    ...
    path('add-experience/<slug:worker_slug>/', views.add_work_experience, name='add_work_experience'),
    ...
    path('restore/<int:pk>/', views.admin_worker_restore, name='admin_worker_restore'),
    path('delete/<int:pk>/', views.admin_worker_delete, name='admin_worker_delete'),
